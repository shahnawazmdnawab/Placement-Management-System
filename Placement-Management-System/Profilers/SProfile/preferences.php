            ...
            <form action="pref.php" class="templatemo-login-form" method="post" enctype="multipart/form-data">
              <div class="row form-group">
				...
				<div class="col-lg-6 col-md-6 form-group">
                  ...
                  <input type="text" name="USN" class="form-control" id="usn" placeholder="0834cs151001" required="">
                </div>
				...
				<div class="col-lg-6 col-md-6 form-group">
                  <label class="control-label templatemo-block">course</label>
                ...
                <div class="col-lg-6 col-md-6 form-group">
                  <label class="control-label templatemo-block">Years Of Passing</label>
