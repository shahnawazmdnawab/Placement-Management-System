...
{ 
 ...
 $check = mysqli_query($connect,"SELECT * FROM sslogin WHERE Enrollment='".$Name."'") or die("Check Query");
 if(mysqli_num_rows($check) == 0) 
 {
  if($repassword == $password)
  {
    ...
    if(mysqli_query($connect,"INSERT INTO sslogin(Enrollment,Name,Password,Email,Question,Answer) VALUES ('$Name', '$USN', '$password','$Email','$Question','$Answer')"))
    {
