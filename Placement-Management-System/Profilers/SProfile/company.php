      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            ...
            <li>
              <a href="company.php"class="active"><i class="fa fa-bar-chart fa-fw"></i>Placement Drives</a>
            </li>
            <li>
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
               <li><a href="../../Homepage/index.php">Home SDBCE-PMS</a></li>
              ...
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>
                    ...
                    <td><a  class="white-text templatemo-sort-by">Tenth</a></td>
                    <td><a  class="white-text templatemo-sort-by">Twelve</a></td>
...
$sql = "SELECT * FROM drive ORDER BY CompName"; 
