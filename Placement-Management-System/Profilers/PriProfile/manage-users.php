...
<html lang="en">
      ...
      ?>
        ...
        <nav class="templatemo-left-nav">          
          ...
          <li><a href="index.php" ><i class="fa fa-home fa-fw"></i>Dashboard</a></li>
            ...
            <li><a href="manage-users.php" class="active"><i class="fa fa-user fa-fw"></i>PTO Details</a></li>
 ...
 <div class="templatemo-content-container">
          ...
          <div class="templatemo-flex-row flex-content-row">
            ...
            <h2 class="margin-bottom-10"> ADD PTO </h2>
            
            <form action="padd.php" class="templatemo-login-form" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-lg-6 col-md-6 form-group">
             ...
             <div class="col-1">              
                ...
                <div class="panel-heading templatemo-position-relative"><h2 class="text-uppercase">PTO Details</h2></div>
...
$sq = "SELECT * FROM plogin";/* ORDER BY ApprovalDate DESC LIMIT $start_from, $num_rec_per_page*/
