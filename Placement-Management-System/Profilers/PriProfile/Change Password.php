...
<?php
        ...
        <ul>
          <li><a href="login.php"><i class="fa fa-home fa-fw" class="active"></i>Dashboard</a></li>
            <li><a href="Students Eligibility.php"><i class="fa fa-bar-chart fa-fw"></i>HOD Details</a></li>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          ...
          <footer class="text-right">
            <p>Copyright &copy; 2019 SDBCE-PMS
            | Developed by <a href="http://znumerique.azurewebsites.net" target="_parent">(s)Square</a></p>
          </footer>       
        </div>
      </div>
    </div>
