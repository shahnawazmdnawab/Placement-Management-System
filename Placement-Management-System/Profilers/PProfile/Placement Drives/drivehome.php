          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li><a href="../../../Homepage/index.php">Home SDBDE-PMS</a></li>
          ...
          <div class="templatemo-content-widget no-padding">
            <div class="panel panel-default table-responsive">
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr> <td><a  class="white-text templatemo-sort-by">Enrollment</a></td>
...
//$sql = "SELECT basicdetail.FirstName,basicdetail.LastName From basicdetail  LIMIT $start_from, $num_rec_per_page"; 
$sql="SELECT basicdetail.FirstName, basicdetail.LastName,placed.Enrollment,placed.CompName
FROM basicdetail RIGHT JOIN placed ON placed.Enrollment = basicdetail.Enrollment ORDER BY basicdetail.FirstName";
...
<td><p><?php echo $row['Enrollment']; ?> </p> </td> 
<td><p><?php echo $row['FirstName']; ?> </p> </td>
<td><p><?php echo $row['LastName']; ?> </p> </td>  <td><p><?php echo $row['CompName']; ?></p> </td>
</tr> 
<?php
}
?>
...
$prev = $currentpage-1;
 ...
 ?> 
          ...
          <footer class="text-right">
           		<p>Copyright &copy; 2015 SDBCE-PMS | Developed by
              <a href="http://znumerique.azurewebsites.net" target="_parent">(s)Square</a>
			  </p>
          </footer>         
        </div>
      </div>
